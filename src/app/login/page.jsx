    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-[#f8fafc] py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-100 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#0A1D2E] mb-2">Login</h1>
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-36 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#007E63] focus:border-transparent transition-all text-gray-900 tracking-widest placeholder-gray-400"
                required
              />
              <div className="absolute inset-y-0 right-0 pr-4 flex items-center">
                <Link 
                  href="/forgot-password" 
                  className="text-sm font-semibold text-[#007E63] hover:text-[#006650] hover:underline transition-all"
                >
                  Forgot Password?
                </Link>
              </div>
          ...
          <button
            type="submit"
            className="w-full bg-[#007E63] hover:bg-[#006650] active:scale-[0.98] text-white py-3.5 rounded-lg font-medium transition-all shadow-sm mt-2"
          >
            Login
          </button>
        </form>
